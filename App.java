...
public class App {
    public void start(Pets petList, Pack_animal packList) {
        ...
        try (Scanner in = new Scanner(System.in)) {
            while (true) {
                System.out.println(
                        "\n1: Новое животное\n2: Показать всех животных\n3: Команды известные животному\n4: Обучение новой команде\n0: Выход");
                String key = in.next();
                switch (key) {
                    case "0":
                    ...
                    try {
                        System.out.println(
                                "Класс животного(выберите нужную цифру)\n1: Домашнее животное\n2: Вьючное животное\n0: Предыдущее меню");
                        String key2 = in.next();
                        switch (key2) {
                            case "0":
                                break;
                            ...
                            case "1":
                                ...
                                switch (keyPet) {
                                    ...
                                    case "2":
                                        String standartDogComands[] = { "Голос", "Сидеть", "Дай лапу" };
                                        System.out.println("Присвойте id животному: \n");
                            ...
                            case "2":
                                ...
                                switch (keyPack) {
                                    ...
                                    case "1":
                                        String standartHorseComands[] = { "Пошла", "Ноо поехали", "Прр стоять" };
                                        System.out.println("Присвойте id животному: \n");
                                    ...
                                    case "2":
                                        String standartDonkeyComands[] = { "Пошел", "Стоп" };
                                        System.out.println("Присвойте id животному: \n");
                    ...
                    case "3":
                        System.out.println("Выбрать животное по id: ");
                        String find = in.next();
                        for (Cats cat : petList.getListCats()) {
                    ...
                    for (Cats cat : petList.getListCats()) {
                        if (cat.getId().equals(findA)){
                            ...
                            System.out.println("За раз можно обучить животное одной команде");
